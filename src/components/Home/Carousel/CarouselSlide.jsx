...
const CarouselSlide = ({title,subtitle,image}) => {
    return (
        ...
        <div className="max-w-6xl px-4 md:px-8 flex flex-col md:flex-row items-center justify-between ">
            {/* Left content */}
            ...
            <div className="w-full md:w-1/2 flex justify-center">
                <img className="max-w-full md:max-w-md dropshadow-lg" src={image} alt="" />
            </div>
        </div>
        </section>
    );
